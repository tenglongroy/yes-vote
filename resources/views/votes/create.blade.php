...
<div class="col-sm-8 blog-main">
    ...
    <script>
        ...
        newDiv += '<div class="row input" id="{@index}_choice1"><input type="text" name="{@index}_choice1" placeholder="{@index}_choice1"/></div>';
        newDiv += '<div class="row input" id="{@index}_choice2"><input type="text" name="{@index}_choice2" placeholder="{@index}_choice2"/></div></div>';
        ...
        $(function() {
            $('#more_question_button').click(function(){
                ...
                $("#question"+(question_index+1)+"_add").click(function(){
                    var newInput = '<div class="row input" id="{@index}"><input type="text" name="{@index}" placeholder="{@index}"/></div>';
